...
local buttons = {
  ...
  val = {
    ...
    button("p", " " .. kind.cmp_kind.Module .. " Projects", "<CMD>Telescope projects<CR>"),
    button(
      "g",
    ...
    button("C", " " .. kind.cmp_kind.Color .. " Colorscheme Config", ":e ~/.config/lvim/lua/theme.lua<CR>"),
